  ...
  function setLanguage(lang) {
    document.getElementsByClassName("header-lang-img").forEach(function (el) {
      if (el) {
        switch (lang) {
          case "en":
            el.src = "/static/images/flags/us.jpg";
            break;
          case "sp":
            el.src = "/static/images/flags/spain.jpg";
            break;
          case "gr":
            el.src = "/static/images/flags/germany.jpg";
            break;
          case "it":
            el.src = "/static/images/flags/italy.jpg";
            break;
          case "ru":
            el.src = "/static/images/flags/russia.jpg";
            break;
          default:
            el.src = "/static/images/flags/us.jpg";
            break;
